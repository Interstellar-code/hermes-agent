...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    # template show <slug>
    p_tmpl_show = tmpl_sub.add_parser(
        "show",
    ...
    p_tmpl_create = tmpl_sub.add_parser(
        "create",
    ...
    p_tmpl_delete = tmpl_sub.add_parser(
        "delete", aliases=["rm"],
        help="Delete a saved template",
    )
    p_tmpl_delete.add_argument("slug", help="Template slug to delete")
    p_tmpl_delete.add_argument(
        "--yes", "-y",
        action="store_true",
        help="Skip the confirmation prompt",
    )

    # template instantiate <slug>
    p_tmpl_inst = tmpl_sub.add_parser(
        "instantiate", aliases=["apply"],
        help="Create board tasks from a template",
    )
    p_tmpl_inst.add_argument("slug", help="Template slug to instantiate")
    p_tmpl_inst.add_argument(
        "--var",
        dest="vars",
        action="append",
        default=[],
    ...
    # template save-board <board-slug>
    p_tmpl_sb = tmpl_sub.add_parser(
        "save-board",
    ...
    p_tmpl_sb.add_argument(
        ...
        dest="template_slug",
        required=True,
        metavar="TEMPLATE_SLUG",
        help="Slug for the new template",
    )
    p_tmpl_sb.add_argument(
        "--name",
        default=None,
        help="Human-readable display name for the template",
    )
    p_tmpl_sb.add_argument(
        "--keep-status",
        action="store_true",
