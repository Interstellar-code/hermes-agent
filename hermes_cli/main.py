...
# Source-of-truth repo for updates. Defaults to the fork (override via
# HERMES_REPO_URL). Fork-detection compares origin against these variants;
# pointing them at the fork means fork users are "official" and the
# upstream-sync path (which would pull NousResearch code) never fires.
